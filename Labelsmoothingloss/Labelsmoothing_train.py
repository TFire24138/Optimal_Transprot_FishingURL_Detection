...
class LabelSmoothingLoss(nn.Module):
    def __init__(self, num_classes, smoothing=0.4):
...
criterion = LabelSmoothingLoss(num_classes=num_classes, smoothing=0.1)  # 如果想用LabelSmoothing Loss，请替换此行
...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 10 == 0:
        ...
        torch.save(model.state_dict(), './10_cnn_epoch_{}.pth'.format(epoch))
